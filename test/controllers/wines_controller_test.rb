...
class WinesControllerTest < ActionController::TestCase
  ...
  test "should create wine" do
    assert_difference('Wine.count') do
      post :create, wine: { country: @wine.country, name: @wine.name, varietal: @wine.varietal, winery: @wine.winery, year: @wine.year }
    end
  ...
  test "should update wine" do
    patch :update, id: @wine, wine: { country: @wine.country, name: @wine.name, varietal: @wine.varietal, winery: @wine.winery, year: @wine.year }
    assert_redirected_to wine_path(assigns(:wine))
  end
