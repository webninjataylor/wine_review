...
Wine.create!(name:'Carnival of Love', year:2012, winery:'Mollydooker', country:'Australia', varietal:'Syrah / Shiraz')
Wine.create!(name:'Chryseia', year:2011, winery:'Prats & Symington', country:'Portugal', varietal:'Touriga Nacional')
Wine.create!(name:'Douro', year:2011, winery:'Quinta Do Vale Meão', country:'Portugal', varietal:'Touriga Nacional')
...
Wine.create!(name:'Châteauneuf-du-Pape', year:2012, winery:'Clos des Papes', country:'France', varietal:'Grenache')
...
Wine.create!(name:'St.-Julien', year:2011, winery:'Château Léoville Las Cases', country:'France', varietal:'Cabernet Sauvignon')
